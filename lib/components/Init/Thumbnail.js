    ...
    function Thumbnail() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.render = function () {
            if (_this.props.thumbnail !== undefined) {
                ...
                return _react2.default.createElement('div', { className: 'wmp-thumbnail-overlay-image', style: style });
            }
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Thumbnail);
