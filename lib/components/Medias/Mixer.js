...
var _Video = require('./Channels/Video');

var _Video2 = _interopRequireDefault(_Video);

var _Audio = require('./Channels/Audio');

var _Audio2 = _interopRequireDefault(_Audio);

var _Slideshow = require('./Channels/Slideshow');

var _Slideshow2 = _interopRequireDefault(_Slideshow);

var _Vinyl = require('./Channels/Vinyl');
    ...
    function Mixer() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.synchronize = function () {
            ...
            if (prevprops.isInitialized === false && _this.props.isInitialized === true) {
                ...
                if (_this.props.hasAudio && (0, _Utils.isNaN)(_this.audio.getDuration())) {
                    _this.audio.load();
                } else if (_this.props.hasVideo && (0, _Utils.isNaN)(_this.video.getDuration())) {
                    _this.video.load();
                } else {
                    _this.play();
                }
            ...
            if (prevprops.askedTime !== _this.props.askedTime && _this.props.duration !== 0 && _this.props.askedTime !== ASKED_TIME_TREATED) {
                ...
                if (_this.props.isReadingTerminated && _this.props.askedTime < _this.props.duration - FLOAT_IMPRECISION) {
                    if ((0, _Utils.isIE)() && _this.props.hasVideo && _this.props.askedTime === 0) {
                        _this.video.load();
                        _this.video.play();
                    }
            ...
            var video = void 0,
                ...
                vinyl = void 0;
            if (_this.props.hasVideo) {
                video = _react2.default.createElement(_Video2.default, { ref: function ref(video) {
                        return _this.video = video;
                    } });
            }
            if (_this.props.hasAudio) {
                audio = _react2.default.createElement(_Audio2.default, { ref: function ref(audio) {
                        return _this.audio = audio;
                    } });
            }
            if (_this.props.hasSlideshow) {
                slideshow = _react2.default.createElement(_Slideshow2.default, { ref: function ref(slideshow) {
                        return _this.slideshow = slideshow;
                    } });
            }
            if (_this.props.hasVinyl && _this.props.isInitialized) {
                vinyl = _react2.default.createElement(_Vinyl2.default, null);
            }
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Mixer);
