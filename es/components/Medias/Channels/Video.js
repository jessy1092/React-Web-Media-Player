...
var Video = function (_Component) {
    ...
    function Video() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.isPlaying = function () {
            ...
            if (!isIE() && _this.video.currentTime < _this.video.duration - FLOAT_IMPRECISION) _this.props.dispatch({ type: 'VIDEO_IS_NOT_READY' });
            ...
            if (isIE() && _this.video.currentTime < _this.video.duration - FLOAT_IMPRECISION && Math.round(_this.video.currentTime * 100) / 100 !== 0) _this.props.dispatch({ type: 'VIDEO_IS_NOT_READY' });
        }, _this.handleSeeked = function () {
            if (isIE()) _this.props.dispatch({ type: 'VIDEO_IS_READY' });
            ...
            return React.createElement(
                ...
                React.createElement('source', { src: _this.props.video })
            );
