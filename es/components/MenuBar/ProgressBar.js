...
var ProgressBar = function (_Component) {
    ...
    function ProgressBar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.handleMouseDown = function (e) {
            ...
            _this.props.dispatch({ type: 'USER_ACTIVE' });
            _this.updateSizeProgressBarDesired(e.clientX - _this.progressBarDesired.getBoundingClientRect().left);
            if (!isInsideElement(_this.progressBarWrapper, e)) _this.props.dispatch({ type: 'UNHIGHLIGHT_PROGRESS_BAR' });
            ...
            if (_this.props.highlightProgressBar) {
                scrubberButton = React.createElement('div', { className: 'wmp-scrubber-button', ref: function ref(node) {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: progressBarClassName }),
                React.createElement('div', { className: progressBarLoadedClassName, style: { width: loadedBarLeftMargin } }),
                React.createElement('div', { className: progressBarProgressionClassName, style: { width: progressBarLeftMargin, backgroundColor: _this.props.color } }),
                React.createElement('div', { className: progressBarDesiredClassName, ref: function ref(progressBarDesired) {
